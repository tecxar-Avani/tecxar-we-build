    ...
    <div>
      ...
      <Button variant="" ref={typeVideo} onClick={() => setType(!type)}>
        ...
        {({ placement, arrowProps, show: _show, popper, ...props }) => (
          ...
          >
           <button className="high-btn">Practical</button><br></br>
           <button className="high-btn">Theoretical</button><br></br>
           
          </div>
        )}
      </Overlay>
            <Button variant="" ref={polarisations} onClick={() => setPolarisation(!polarisation)}>
            <figure className="ms-3">
              <Image
            ...
            <Overlay target={polarisations.current} show={polarisation} placement="right">
        {({ placement, arrowProps, show: _show, popper, ...props }) => (
          <div
            {...props}
            style={{
          ...
          >
           ...
           <button className="high-btn">Medium</button><br></br>
           <button className="high-btn">High</button>
           <button className="high-btn mt-0">Very <br></br>High</button>
          </div>
        )}
      </Overlay>
      <Button variant="" ref={target2} onClick={() => setDifficulty(!difficulty)}>
            <figure className="ms-3">
              <Image
      ...
      <Tooltip placement="topLeft" title="Please make an account to save your build - dont let all your hard work go to waste!Login via Google" arrowPointAtCenter color="#FAEFAF">
