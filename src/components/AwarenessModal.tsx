  ...
  const today = new Date()
    ...
    return (
      ...
      >
        ...
        >
           <Form.Item>
        <div className={`inputbox awarenessModal AwareInput ${props.className}`}><TextArea id={props.id} rows={3} className="mb-2 AwareInput" readOnly={true} defaultValue={props.textValue ? props.textValue : ""}></TextArea></div></Form.Item>
